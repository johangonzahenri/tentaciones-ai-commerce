  ...
  return [
    {
      ...
      variants: [
        ...
        { sku: "POL-WHT-L", color: "Blanco Crudo", size: "L", priceCLP: 22990, stock: 20 },
      ],
    },
    {
      id: "prod-camisa-lino",
      ...
      brand: "Tentaciones Atelier",
      category: "camisas",
      description: "Camisa de corte relajado elaborada en lino italiano prelavado con cuello cubano.",
      basePriceCLP: 45990,
      currency: "CLP",
      tags: ["camisa", "lino", "verano", "resort", "beige"],
      arAvailable: true,
      has3D: true,
      ...
      variants: [
        { sku: "CAM-BGE-S", color: "Beige Arena", size: "S", priceCLP: 45990, stock: 12 },
        { sku: "CAM-BGE-M", color: "Beige Arena", size: "M", priceCLP: 45990, stock: 18 },
        { sku: "CAM-BGE-L", color: "Beige Arena", size: "L", priceCLP: 45990, stock: 15 },
      ],
    },
    {
      ...
      category: "polerones",
      description: "Polerón con capucha estructurado sin cordones en algodón French Terry de 450 GSM.",
      basePriceCLP: 49990,
      currency: "CLP",
      tags: ["poleron", "hoodie", "streetwear", "gris"],
      arAvailable: true,
      has3D: true,
      ...
      variants: [
        { sku: "HOD-GRY-S", color: "Gris Melange", size: "S", priceCLP: 49990, stock: 15 },
        { sku: "HOD-GRY-M", color: "Gris Melange", size: "M", priceCLP: 49990, stock: 22 },
        { sku: "HOD-GRY-L", color: "Gris Melange", size: "L", priceCLP: 49990, stock: 18 },
      ],
    },
    {
      ...
      category: "chaquetas",
      description: "Chaqueta técnica impermeable ultra-liviana de 2.5 capas con costuras termoselladas.",
      basePriceCLP: 89990,
      currency: "CLP",
      tags: ["chaqueta", "impermeable", "running", "waterproof"],
      arAvailable: true,
      has3D: true,
      ...
      variants: [
        { sku: "SSJ-BLK-S", color: "Negro Noche", size: "S", priceCLP: 89990, stock: 15 },
        { sku: "SSJ-BLK-M", color: "Negro Noche", size: "M", priceCLP: 89990, stock: 25 },
        { sku: "SSJ-BLK-L", color: "Negro Noche", size: "L", priceCLP: 89990, stock: 20 },
      ],
    },
    {
      ...
      variants: [
        { sku: "SED-NOIR-S", color: "Noir Velvet", size: "S", priceCLP: 139990, stock: 8 },
        { sku: "SED-NOIR-M", color: "Noir Velvet", size: "M", priceCLP: 139990, stock: 12 },
        { sku: "SED-NOIR-L", color: "Noir Velvet", size: "L", priceCLP: 139990, stock: 6 },
      ],
    },
    {
      ...
      brand: "Tentaciones Urban",
      category: "pantalones",
      description: "Pantalón técnico con tratamiento repelente al agua DWR y 6 bolsillos de acceso rápido.",
      basePriceCLP: 59990,
      currency: "CLP",
      tags: ["pantalon", "cargo", "techwear", "tactico"],
      arAvailable: true,
      has3D: true,
      ...
      variants: [
        { sku: "CAR-BLK-30", color: "Negro Stealth", size: 30, priceCLP: 59990, stock: 14 },
        { sku: "CAR-BLK-32", color: "Negro Stealth", size: 32, priceCLP: 59990, stock: 20 },
        { sku: "CAR-BLK-34", color: "Negro Stealth", size: 34, priceCLP: 59990, stock: 16 },
      ],
    },
    {
      ...
      brand: "Tentaciones Atelier",
      category: "faldas",
      description: "Falda midi plisada soleil con acabado sutilmente satinado y pretina elástica.",
      basePriceCLP: 39990,
      currency: "CLP",
      ...
      variants: [
        { sku: "FAL-GLD-S", color: "Champagne Gold", size: "S", priceCLP: 39990, stock: 10 },
        { sku: "FAL-GLD-M", color: "Champagne Gold", size: "M", priceCLP: 39990, stock: 15 },
      ],
    },
    {
      ...
      variants: [
        { sku: "PCR-BLK-39", color: "Black / Stealth", size: 39, priceCLP: 119990, stock: 12 },
        { sku: "PCR-BLK-40", color: "Black / Stealth", size: 40, priceCLP: 119990, stock: 18 },
        { sku: "PCR-BLK-41", color: "Black / Stealth", size: 41, priceCLP: 119990, stock: 15 },
    ...
    },
    {
      ...
      brand: "Tentaciones Sport",
      category: "accesorios",
      description: "Pack de 3 pares de calcetines técnicos con soporte de arco plantar y lana merino.",
      basePriceCLP: 19990,
      currency: "CLP",
      tags: ["calcetines", "accesorios", "running"],
      arAvailable: false,
      has3D: false,
      variants: [
        { sku: "ABS-WHT-M", color: "Blanco / Gris", size: "M (39-42)", priceCLP: 19990, stock: 50 },
        { sku: "ABS-BLK-M", color: "Negro / Gris", size: "M (39-42)", priceCLP: 19990, stock: 60 },
      ],
    },
  ];
}
