...
STATUS: CERTIFIED
SECURITY CLASSIFICATION: COMMERCIAL & SHOWCASE GUIDE
CORRESPONDING CODE CONTRACT: ITentacionesExperienceService / UI Showcase Drawer
============================================================

## 1. Showcase Overview

*Tentaciones AI Commerce* is **Project 01 (`PROJ-01-TENTACIONES`)** in the application portfolio powered by **AI Operating Platform**. It serves as the primary flagship reference application to demonstrate the platform's commercial value proposition in retail, apparel, and footwear e-commerce.

---

## 2. Key Demonstration Pillars
...
- **Value:** Shows how Web, Mobile, and In-Store kiosks all tap into a unified, secure TypeScript contract (`ITentacionesExperienceService`).

### Pillar 4: Safe Commercial Checkout Simulation
...
- **Live Metrics Bar:**
  ...
  - **AR Engagement Time:** **4.2 min** average interactive session time.
  - **Security Isolation:** **100%** fail-closed isolation in public environments.

---

## 3. Presentation Script & Flow (5-Minute Tour)

1. **Minute 1: Introduction & Isolation (Top Banner)**
   - Highlight the *Public Demo* badge and explain that the system operates in 100% synthetic isolation with zero secrets.
2. **Minute 2: Natural Discovery & AI Search**
   - Type *"running"* or *"vestido"* in the search box; show immediate instant filtering and bilingual toggle (Spanish / English).
3. **Minute 3: AR Try-On & Biometric Avatars**
